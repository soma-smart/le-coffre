...
from .group_demote_owner_routes import router as group_demote_owner_router
from .group_events_list_routes import router as group_events_list_router
...
__all__ = [
    ...
    "group_demote_owner_router",
    "group_remove_member_router",
    "group_update_router",
    "get_group_router",
    "list_groups_router",
    "group_delete_router",
    "group_events_list_router",
]
