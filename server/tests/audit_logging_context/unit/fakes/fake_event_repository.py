...
class FakeStoredEvent:
    """Implementation of StoredEvent for unit testing"""
    ...
    def __init__(self, event: DomainEvent):
        ...
        # Convert event attributes to event_data dict per repository contract
        self.event_data = {
            key: str(value)
...
class FakeEventRepository:
    ...
    def list_events(
        ...
        return [FakeStoredEvent(event) for event in filtered_events]
