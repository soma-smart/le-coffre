...
def test_given_non_owner_user_when_sharing_access_should_raise_user_not_owner_error(
    ...
    password_permissions_repository.grant_access(non_owner_group_id, password.id, PasswordPermission.READ)
    group_access_gateway.set_group_owner(non_owner_group_id, non_owner_id)
    # Register third group
    group_access_gateway.set_group_owner(third_group_id, UUID("ad742e0e-bb76-4728-83ef-8d546d7c62e8"))
