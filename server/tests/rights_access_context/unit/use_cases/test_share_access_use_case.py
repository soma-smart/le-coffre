...
def test_given_owner_when_sharing_with_nonexistent_user_should_fail(
    ...
    with pytest.raises(UserNotFoundError):
        use_case.execute(ShareResourceCommand(owner_id, nonexistent_user_id, resource_id))
    
    # Assert: Non-existent user should not have access
    assert rights_repository.has_permission(nonexistent_user_id, resource_id, Permission.READ) is False
