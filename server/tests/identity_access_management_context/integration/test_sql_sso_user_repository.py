...
from identity_access_management_context.domain.exceptions import SsoUserAlreadyExistsException

pytest.fixture(scope="function")
def test_save_sso_user_and_get_by_iud(sql_sso_user_repository): #iud = internal user id
  sso_user = SsoUser(
  ...
  print("Saving SSO User:", sso_user)
