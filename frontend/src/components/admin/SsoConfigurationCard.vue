    ...
    <template #content>
      ...
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <Password inputId="client-secret" v-model="formData.client_secret" placeholder="Enter OAuth2 Client Secret"
            :invalid="submitted && !formData.client_secret" :feedback="false" toggleMask fluid required />
