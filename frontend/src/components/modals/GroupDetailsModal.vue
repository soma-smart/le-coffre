            ...
            >
              <template #content>
                <div class="flex justify-between items-center py-1">
                  ...
                  <!-- Remove button (only for owner, not for self, and not in personal groups) -->
                  <div v-if="isOwner && !group.is_personal && user.id !== currentUserId">
                    <Button 
                      icon="pi pi-times"
                      text
                      rounded
            ...
            >
              <template #content>
                <div class="flex justify-between items-center py-1">
                  ...
                  <!-- Remove button (only for owner of non-personal groups) -->
                  <div v-if="isOwner && !group.is_personal">
                    <Button 
                      icon="pi pi-times"
                      text
                      rounded
