 ...
 * - **Authorization**: Only administrators can access this endpoint
 */
export const listPasswordEventsByActorAdminUsersUserIdPasswordEventsGet = <ThrowOnError extends boolean = false>(options: Options<ListPasswordEventsByActorAdminUsersUserIdPasswordEventsGetData, ThrowOnError>) => (options.client ?? client).get<ListPasswordEventsByActorAdminUsersUserIdPasswordEventsGetResponses, ListPasswordEventsByActorAdminUsersUserIdPasswordEventsGetErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
...
/**
 * Create passwords from KeePass file
 */
export const createPasswordsFromKeepassPasswordsKeepassPost = <ThrowOnError extends boolean = false>(options: Options<CreatePasswordsFromKeepassPasswordsKeepassPostData, ThrowOnError>) => (options.client ?? client).post<CreatePasswordsFromKeepassPasswordsKeepassPostResponses, CreatePasswordsFromKeepassPasswordsKeepassPostErrors, ThrowOnError>({
 ...
 */
export const getStatisticForAdminIamStatisticsGet = <ThrowOnError extends boolean = false>(options?: Options<GetStatisticForAdminIamStatisticsGetData, ThrowOnError>) => (options?.client ?? client).get<GetStatisticForAdminIamStatisticsGetResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
