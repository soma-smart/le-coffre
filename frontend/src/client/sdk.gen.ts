 ...
 * - **Authentication**: Requires authentication via access_token cookie
 */
export const searchUsersUsersSearchGet = <ThrowOnError extends boolean = false>(options: Options<SearchUsersUsersSearchGetData, ThrowOnError>): RequestResult<SearchUsersUsersSearchGetResponses, SearchUsersUsersSearchGetErrors, ThrowOnError> => (options.client ?? client).get<SearchUsersUsersSearchGetResponses, SearchUsersUsersSearchGetErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
