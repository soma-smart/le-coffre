 ...
 */
export const updateShareExpirationPasswordsPasswordIdShareGroupIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateShareExpirationPasswordsPasswordIdShareGroupIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateShareExpirationPasswordsPasswordIdShareGroupIdPatchResponses, UpdateShareExpirationPasswordsPasswordIdShareGroupIdPatchErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
