...
/**
 * Demote an owner to a regular member
 *
 ...
 */
export const demoteOwnerToMemberGroupsGroupIdOwnersUserIdDelete = <ThrowOnError extends boolean = false>(options: Options<DemoteOwnerToMemberGroupsGroupIdOwnersUserIdDeleteData, ThrowOnError>): RequestResult<DemoteOwnerToMemberGroupsGroupIdOwnersUserIdDeleteResponses, DemoteOwnerToMemberGroupsGroupIdOwnersUserIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DemoteOwnerToMemberGroupsGroupIdOwnersUserIdDeleteResponses, DemoteOwnerToMemberGroupsGroupIdOwnersUserIdDeleteErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
...
/**
 * List membership events for a group
 *
 ...
 * - **Authentication**: Requires authentication via access_token cookie
 */
export const listGroupEventsGroupsGroupIdEventsGet = <ThrowOnError extends boolean = false>(options: Options<ListGroupEventsGroupsGroupIdEventsGetData, ThrowOnError>): RequestResult<ListGroupEventsGroupsGroupIdEventsGetResponses, ListGroupEventsGroupsGroupIdEventsGetErrors, ThrowOnError> => (options.client ?? client).get<ListGroupEventsGroupsGroupIdEventsGetResponses, ListGroupEventsGroupsGroupIdEventsGetErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'access_token',
            type: 'apiKey'
